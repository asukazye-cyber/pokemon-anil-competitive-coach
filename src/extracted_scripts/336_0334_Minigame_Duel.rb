...
class PokemonDuel
  ...
  def pbDuel(opponent, event, speeches)
    ...
    loop do
      ...
      list = [
        _INTL("DEFENDER"),
        _INTL("ATAQUE PRECISO"),
        _INTL("ATAQUE FUERTE")
      ]
      list.push(_INTL("ATAQUE ESPECIAL")) if !@special[0]
      command = pbMessage(_INTL("Elige un comando."), list, 0)
      ...
      if action == 0 && command == 0
        ...
        pbMoveRoute(event,
                    [PBMoveRoute::SCRIPT_ASYNC, "moveLeft90",
                     ...
                     PBMoveRoute::SCRIPT_ASYNC, "moveLeft90"])
        pbWait(0.5)
        pbMessage(_INTL("Estudiáis vuestros movimientos mutuamente..."))
        ...
        @hp[1] -= 1
        pbMessage(_INTL("¡Tu ataque no ha sido bloqueado!"))
        ...
        pbMoveRoute(event,
                    [PBMoveRoute::CHANGE_SPEED, 2,
                     PBMoveRoute::FORWARD])
        pbMessage(_INTL("¡Tu ataque ha sido esquivado!"))
        ...
        pbMoveRoute(event,
                    [PBMoveRoute::CHANGE_SPEED, 2,
                     PBMoveRoute::FORWARD])
        @hp[1] -= 3
        pbMessage(_INTL("¡Has perforado las defensas de tu enemigo!"))
        ...
        pbMoveRoute(event,
                    [PBMoveRoute::CHANGE_SPEED, 2,
                     PBMoveRoute::BACKWARD])
        @hp[0] -= 1
        pbMessage(_INTL("¡Fallaste al bloquear el ataque del oponente!"))
        ...
        pbMessage(_INTL("¡Cruzas espadas con tu oponente!"))
        ...
        pbMessage(_INTL("¡Os golpeáis mutuamente!"))
        ...
        pbMoveRoute(event,
                    [PBMoveRoute::CHANGE_SPEED, 2,
                     PBMoveRoute::BACKWARD])
        pbMessage(_INTL("¡Has esquivado el ataque de tu oponente!"))
        ...
        pbMoveRoute(event,
                    [PBMoveRoute::CHANGE_SPEED, 2,
                     PBMoveRoute::BACKWARD])
        @hp[0] -= 3
        pbMessage(_INTL("¡El oponente ha perforado tus defensas!"))
        ...
        @hp[0] -= 4
        @hp[1] -= 4
        pbMessage(_INTL("¡Vuestros ataques especiales han colisionado!"))
      end
    end
    pbEndDuel
    return decision
