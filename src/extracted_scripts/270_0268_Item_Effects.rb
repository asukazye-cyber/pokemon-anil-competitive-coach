...
ItemHandlers::UseOnPokemon.copy(:MAXREVIVE, :MAXHONEY, :CENIZASSAGRADAS)
...
ItemHandlers::UseOnPokemonMaximum.add(:HEALTHMOCHI, proc { |item, pkmn|
  next pbMaxUsesOfEVRaisingItem(:HP, 50, pkmn, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemon.add(:HEALTHMOCHI, proc { |item, qty, pkmn, scene|
  next pbUseEVRaisingItem(:HP, 50, qty, pkmn, "vitamin", scene, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemonMaximum.add(:MUSCLEMOCHI, proc { |item, pkmn|
  next pbMaxUsesOfEVRaisingItem(:ATTACK, 50, pkmn, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemon.add(:MUSCLEMOCHI, proc { |item, qty, pkmn, scene|
  next pbUseEVRaisingItem(:ATTACK, 50, qty, pkmn, "vitamin", scene, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemonMaximum.add(:RESISTMOCHI, proc { |item, pkmn|
  next pbMaxUsesOfEVRaisingItem(:DEFENSE, 50, pkmn, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemon.add(:RESISTMOCHI, proc { |item, qty, pkmn, scene|
  next pbUseEVRaisingItem(:DEFENSE, 50, qty, pkmn, "vitamin", scene, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemonMaximum.add(:GENIUSMOCHI, proc { |item, pkmn|
  next pbMaxUsesOfEVRaisingItem(:SPECIAL_ATTACK, 50, pkmn, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemon.add(:GENIUSMOCHI, proc { |item, qty, pkmn, scene|
  next pbUseEVRaisingItem(:SPECIAL_ATTACK, 50, qty, pkmn, "vitamin", scene, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemonMaximum.add(:CLEVERMOCHI, proc { |item, pkmn|
  next pbMaxUsesOfEVRaisingItem(:SPECIAL_DEFENSE, 50, pkmn, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemon.add(:CLEVERMOCHI, proc { |item, qty, pkmn, scene|
  next pbUseEVRaisingItem(:SPECIAL_DEFENSE, 50, qty, pkmn, "vitamin", scene, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemonMaximum.add(:SWIFTMOCHI, proc { |item, pkmn|
  next pbMaxUsesOfEVRaisingItem(:SPEED, 50, pkmn, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemon.add(:SWIFTMOCHI, proc { |item, qty, pkmn, scene|
  next pbUseEVRaisingItem(:SPEED, 50, qty, pkmn, "vitamin", scene, Settings::NO_VITAMIN_EV_CAP)
})
...
ItemHandlers::UseOnPokemon.add(:KELPSYBERRY, proc { |item, qty, pkmn, scene|
  next pbRaiseHappinessAndLowerEV(
    pkmn, scene, :ATTACK, qty, [
      _INTL("¡{1} te adora! ¡Su Ataque de base bajó!", pkmn.name),
...
ItemHandlers::UseOnPokemon.add(:QUALOTBERRY, proc { |item, qty, pkmn, scene|
  next pbRaiseHappinessAndLowerEV(
    pkmn, scene, :DEFENSE, qty, [
      _INTL("¡{1} te adora! ¡Su Defensa de base bajó!", pkmn.name),
...
ItemHandlers::UseOnPokemon.add(:HONDEWBERRY, proc { |item, qty, pkmn, scene|
  next pbRaiseHappinessAndLowerEV(
    pkmn, scene, :SPECIAL_ATTACK, qty, [
      _INTL("¡{1} te adora! ¡Su Ataque Especial de base bajó!", pkmn.name),
...
ItemHandlers::UseOnPokemon.add(:GREPABERRY, proc { |item, qty, pkmn, scene|
  next pbRaiseHappinessAndLowerEV(
    pkmn, scene, :SPECIAL_DEFENSE, qty, [
      _INTL("¡{1} te adora! ¡Su Defensa Especial de base bajó!", pkmn.name),
...
ItemHandlers::UseOnPokemon.add(:TAMATOBERRY, proc { |item, qty, pkmn, scene|
  next pbRaiseHappinessAndLowerEV(
    pkmn, scene, :SPEED, qty, [
      _INTL("¡{1} te adora! ¡Su Velocidad de base bajó!", pkmn.name),
      _INTL("{1} se ha vuelto más amable. ¡Su Velocidad de base ya no puede bajar más!", pkmn.name),
      _INTL("{1} se ha vuelto más amable. ¡Pero tiene menos Velocidad de base!", pkmn.name)
    ]
  )
})
...
ItemHandlers::UseOnPokemon.add(:SUPERCAPSULE, proc { |item, qty, pkmn, scene|
    if pkmn.forced_ability? && pkmn.traded?
      if !pbConfirmMessage(_INTL("Este Pokémon fue intercambiado y tiene la habilidad {1}. Si la cambias, perderá esa habilidad. ¿Quieres continuar?", GameData::Ability.get(pkmn.ability).name))
        next false
      end
    end
