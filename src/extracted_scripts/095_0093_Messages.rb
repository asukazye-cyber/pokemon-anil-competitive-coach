...
#===============================================================================
def pbGetGoldString
  return _INTL("{1} Moedas", $player.money.to_s_formatted)
end

def pbDisplayGoldWindow(msgwindow)
  moneyString = pbGetGoldString
  goldwindow = Window_AdvancedTextPokemon.new(_INTL("Moedas:\n<ar>{1}</ar>", moneyString))
...
def pbMessageDisplay(msgwindow, message, letterbyletter = true, commandProc = nil)
  ...
  text.gsub!(/\\pm/i,  _INTL("{1} Moedas", $player.money.to_s_formatted)) if $player
  text.gsub!(/\\n/i,   "\n")
