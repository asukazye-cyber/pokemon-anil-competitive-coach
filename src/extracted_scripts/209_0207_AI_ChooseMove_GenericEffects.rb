    ...
    each_battler do |b, i|
      ...
      if @trainer.medium_skill? && !b.has_active_item?(:UTILITYUMBRELLA)
        beneficial_abilities = {
          ...
          :Hail      => [:FORECAST, :ICEBODY, :SLUSHRUSH, :SNOWCLOAK, :PODERGELIDO]
        }[weather]
