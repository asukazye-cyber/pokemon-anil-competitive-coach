...
class SameSpeciesClause
  ...
  def errorMessage
    return _INTL("Los Pokémon deben ser de la misma especie.")
  end
end
...
class SpeciesClause
  ...
  def errorMessage
    return _INTL("Los Pokémon no pueden ser de la misma especie.")
  end
end
...
class TotalLevelRestriction
  ...
  def errorMessage
    return _INTL("Los niveles combinados exceden {1}.", @level)
  end
end
...
class ItemClause
  ...
  def errorMessage
    return _INTL("No se pueden llevar objetos repetidos.")
  end
end
