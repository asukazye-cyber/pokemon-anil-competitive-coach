...
# SaveData.register_conversion(:v21_remove_infinite_repel_items) do
#   game_version "1.0.7"
#   display_title "Eliminando elementos de Repelente Infinito"
#   to_value :global_metadata do |global|
#     # Turn off infinite repel if it's active
#     if global.infRepel
#       global.infRepel = false
#     end
#   end
#   to_value :bag do |bag|
#     # Remove INFREPEL and INFREPELOFF items from the bag
#     if bag.has?(:INFREPEL)
#       bag.remove(:INFREPEL, bag.quantity(:INFREPEL))
#     end
#     if bag.has?(:INFREPELOFF)
#       bag.remove(:INFREPELOFF, bag.quantity(:INFREPELOFF))
#     end
#     # Remove from registered items if present 
#     if bag.registered_items.include?(:INFREPEL)
#       bag.registered_items.delete(:INFREPEL)
#     end
#     if bag.registered_items.include?(:INFREPELOFF)
#       bag.registered_items.delete(:INFREPELOFF)
#     end
#   end
# end