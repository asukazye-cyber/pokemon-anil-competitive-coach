...
module Settings
  ...
  # Numerador sobre 65536: a chance e "d < SHINY_POKEMON_CHANCE", com d uniforme
  # em 0..65535. 13/65536 = 1 em 5041 (alvo: 1/5000). Estava 65 = 1 em 1008.
  #
  # ⚠️ EVENTO DE SHINY — DOBRO DA CHANCE (15/08/2026). VALOR TEMPORARIO.
  #
  #   normal : 13 -> 1 em 5041
  #   evento : 26 -> 1 em 2521
  #
  # PARA ENCERRAR: voltar a 13. Nada mais precisa de ser mexido aqui.
  #
  # O super shiny NAO tem valor proprio: ele e uma fatia dos shinies (1/3, no
  # 0278_Pokemon.rb). Dobrando esta base, ele dobra junto — 1/15123 passa a
  # 1/7563 — e a proporcao entre os dois fica igual. Foi o que evitou repetir o
  # ajuste do evento anterior, que teve de mexer no divisor para acertar alvos.
  SHINY_POKEMON_CHANCE = 13 #(MECHANICS_GENERATION >= 6) ? 16 : 8
