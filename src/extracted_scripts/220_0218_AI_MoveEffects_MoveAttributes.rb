...
Battle::AI::Handlers::MoveEffectAgainstTargetScore.add("RecoilQuarterOfDamageDealt",
  proc { |score, move, user, target, ai, battle|
    next score if !user.battler.takesIndirectDamage? || user.has_active_ability?(:ROCKHEAD) || user.has_active_ability?(:ICEHEAD)
...
Battle::AI::Handlers::MoveEffectAgainstTargetScore.add("RecoilThirdOfDamageDealtParalyzeTarget",
  proc { |score, move, user, target, ai, battle|
    ...
    if user.battler.takesIndirectDamage? && !user.has_active_ability?(:ROCKHEAD) && !user.has_active_ability?(:ICEHEAD)
