...
class PokemonTrainerCard_Scene
  ...
  def pbDrawTrainerCardFront
    ...
    textPositions = [
      ...
      [_INTL("No. ID"), 332, 70, :left, baseColor, shadowColor],
      [sprintf("%05d", $player.public_ID), 468, 70, :right, baseColor, shadowColor],
      [_INTL("Moedas"), 34, 118, :left, baseColor, shadowColor],
      [_INTL("{1} Moedas", $player.money.to_s_formatted), 302, 118, :right, baseColor, shadowColor],
      ...
      [_INTL("Tiempo"), 34, 214, :left, baseColor, shadowColor],
      [time, 302, 214, :right, baseColor, shadowColor],
      [_INTL("Comienzo"), 34, 262, :left, baseColor, shadowColor],
