...
#    PBDebug.log("[Mind: #{@mind.inspect}, Skill: #{@skill.inspect}]")
    ...
    if points[0] == points[1]
      ...
      pbDisplay(_INTL("¡{1} perdió contra el {2} rival por decisión del árbitro!",
                      @battlers[0].name, @battlers[1].name))
      @battlers[0].hp = 0
      @battlers[0].pbFaint(false)
    end
...
class Battle::Scene
  ...
  def updateJudgment(window, phase, battler1, battler2, ratings1, ratings2)
    ...
    textpos = [
      ...
      [_INTL("Mente"), 144, 54, :center, Color.new(72, 72, 72), Color.new(208, 208, 200)],
      [_INTL("Habilidad"), 144, 86, :center, Color.new(72, 72, 72), Color.new(208, 208, 200)],
      [_INTL("Cuerpo"), 144, 118, :center, Color.new(72, 72, 72), Color.new(208, 208, 200)],
      [total1.to_s, 64, 166, :center, Color.new(72, 72, 72), Color.new(208, 208, 200)],
      [_INTL("Juicio"), 144, 166, :center, Color.new(72, 72, 72), Color.new(208, 208, 200)],
