...
#===============================================================================
# Effectiveness against Bug-type is 2x. (Atrapabicho)
#===============================================================================
...
class Battle::Move::AddGhostTypeToTarget < Battle::Move
  ...
  def pbEffectAgainstTarget(user, target)
    ...
    @battle.pbDisplay(_INTL("¡{1} ahora también tiene el tipo {2}!", target.pbThis, typeName))
...
class Battle::Move::DamageTargetAddSpikesToFoeSide < Battle::Move
  def pbEffectWhenDealingDamage(user, target)
    ...
    @battle.scene.pbUpdateHazardSprites
  end
end
